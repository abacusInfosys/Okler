...
public class UIUtils {
    ...
    public static RelativeLayout addRemoveUnits(RelativeLayout unitLayout,final Activity ack){
    	...
    	RelativeLayout red_minus_ImageRl = (RelativeLayout)unitLayout.findViewById(R.id.red_minus_ImageRl);
    	RelativeLayout red_plus_ImageRl = (RelativeLayout)unitLayout.findViewById(R.id.red_plus_ImageRl);
