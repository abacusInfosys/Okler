...
public class CheckoutListViewAdapter extends BaseAdapter{
	 ...
	 int [] imageId;
	      ...
	      int check;
	      public CheckoutListViewAdapter(Context con, ArrayList<ProductDataBean> ordList,boolean isCheckout2,int check1)
	      {
	    	  //result=prgmNameList;
	          context=con;
	          ack = (Activity)con;
	    ...
	    public View getView(final int position, View convertView, ViewGroup parent) {
	        ...
	        View rowView;
	             ...
	             holder.item_img=(NetworkImageView) rowView.findViewById(R.id.item_image);
	             holder.item_name=(TextView) rowView.findViewById(R.id.item_name);
	             holder.item_desc=(TextView)rowView.findViewById(R.id.item_description);
	             ...
	             holder.red_plus_Image = (ImageView)rowView.findViewById(R.id.red_plus_Image);
	             holder.red_minus_Image = (ImageView)rowView.findViewById(R.id.red_minus_Image);
	             holder.red_plus_ImageRl = (RelativeLayout)rowView.findViewById(R.id.red_minus_ImageRl);
	             holder.red_minus_ImageRl = (RelativeLayout)rowView.findViewById(R.id.red_minus_ImageRl);
	             ...
	             /* for (int j = 0; j < pdList.size()	; j++) {*/
	            	 ...
	            	 strikethroughMRP.setSpan(new StrikethroughSpan(), 0, strikethroughMRP.length(), 0);
	            	 ...
	            	 if(Okler.getInstance().getBookingType()==0){
	            	 holder.item_desc.setText(gen_name+"\n"+company);
	            	 }else{
	            		 holder.item_desc.setText(pdList.get(position).getDesc());
	            	 }
	            	 ...
	            	 holder.okler_price.setText(holder.okler_price.getText().toString()+pdList.get(position).getOklerPrice());
	            ...
	            holder.red_plus_Image.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(uni.length()>2){
							...
							int unit = Integer.parseInt(holder.units.getText().toString());
							if(unit>=99){
								Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
							}else{
						...
						//Toast.makeText(context, "You Clicked "+unit, Toast.LENGTH_LONG).show();
						}
						}
					}
				});	 
	        ...
	        /* rowView.setOnClickListener(new OnClickListener() {
	            ...
	            public void onClick(View v) {
	            	...
	            	Intent intent = new Intent(context, HealthShopActivity2.class);
	            	context.startActivity(intent);
	                Toast.makeText(context, "You Clicked "+pdList.get(position), Toast.LENGTH_LONG).show();
	            }
	        });*/
	...
	public void deleteFromCart(int prodId,final int position){
		...
		//		Toast.makeText(getApplicationContext(), "onResponse", Toast.LENGTH_SHORT).show();
			...
			public void onErrorResponse(VolleyError error) {
				//Toast.makeText(ack, String.valueOf(error), Toast.LENGTH_SHORT).show();	
