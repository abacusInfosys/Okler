...
import com.okler.adapters.HealthShopListAdapter.Holder;
...
//	String photoURl ="http://183.82.110.105:8081/oklerdevv2/uploads/prescription/";
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //	 holder.singleImg.setImageUrl(fName, imgLoader);
       	// 	if(holder.singleImg.getVisibility() == View.INVISIBLE)
      ...
      /*       Resources r = context.getResources();
             ...
             layers[0] = r.getDrawable(R.drawable.camera);
             layers[1] = r.getDrawable(R.drawable.gallery);
             LayerDrawable layerDrawable = new LayerDrawable(layers);
             holder.img.setImageDrawable(layerDrawable);*/
             
             //holder.img.setImageDrawable(context.getResources().getDrawable(R.drawable.layer));
