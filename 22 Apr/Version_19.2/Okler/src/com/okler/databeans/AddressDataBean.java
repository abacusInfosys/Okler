...
public class AddressDataBean {
    ...
    String relation; 
    String relationId;
    String genderId,ship_add1, ship_add2, ship_city, ship_state, ship_zip,bill_add1, bill_add2, bill_city, bill_state, bill_zip;
    String ship_fname,ship_lname,bill_fname,bill_lname,shipSalut="",billSalut="";
