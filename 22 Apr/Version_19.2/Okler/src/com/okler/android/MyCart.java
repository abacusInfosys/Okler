...
public class MyCart extends BaseActivity implements Response.Listener,Response.ErrorListener{
	...
	ImageView deleteImage,image_favourite,deleteImagehs,image_favouritehs,red_plus_Image,red_minus_Image,red_plus_Imagehs,red_minus_Imagehs;
	TextView item_name,item_desc,mrp,you_save,item_namehs,item_deschs,mrphs,you_savehs,tv_prescriptionRequired,amount_value_tv,okler_disc_value_tv,shipping_charg_value_tv,tax_value_tv,net_pay_value_tv;
	       ...
	       submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				for(int i = 0;i<count1;i++){
					...
					EditText ed = (EditText)va[i].findViewById(id);
					String edtext = ed.getText().toString();
					if(edtext==null||edtext.equals("")||edtext.equals("00")||edtext.equals("null"))
						edtext = "00";
					if(edtext.length()>2){
						Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
						flag=false;
						break;
					}else{
					...
					//Toast.makeText(ack, edtext, Toast.LENGTH_SHORT).show();
					id++;
					flag=true;
				}
				if(count1==0)
				...
				for (int j = 0; j < count2; j++) {
					...
					EditText ed2 = (EditText)va2[j].findViewById(id2);
					String edtext2 = ed2.getText().toString();
					if(edtext2==null||edtext2.equals("")||edtext2.equals("00")||edtext2.equals("null"))
						edtext2 = "00";
					if(edtext2.length()>2){
						Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
						flag=false;
	...
	private void setHS() {
		final ArrayList<ProductDataBean> setPdLisths = new ArrayList<ProductDataBean>();
		...
		for (int i = 0; i < size1; i++) {
			...
			item_imghs=(NetworkImageView) rowViewhs[i].findViewById(R.id.item_image);
            item_namehs=(TextView) rowViewhs[i].findViewById(R.id.item_name);
            item_deschs=(TextView)rowViewhs[i].findViewById(R.id.item_description);
            mrphs = (TextView)rowViewhs[i].findViewById(R.id.tv_MrpValue);
            you_savehs = (TextView)rowViewhs[i].findViewById(R.id.tv_youSaveValue);
            okler_pricehs = (Button)rowViewhs[i].findViewById(R.id.okler_Amount);
            RelativeLayout unitValueRlhs = (RelativeLayout)rowViewhs[i].findViewById(R.id.unitValueRl);
            unitshs = (EditText)rowViewhs[i].findViewById(R.id.unitValue);
            int t2 = i+500;
            unitshs.setTag(t2+"");
            unitshs.setId(i+50000);
        //    myTextWatcher(unitshs);
            deleteImagehs=(ImageView)rowViewhs[i].findViewById(R.id.deleteImage);
            deleteImagehs.setTag(""+i);
            image_favouritehs=(ImageView)rowViewhs[i].findViewById(R.id.image_favourite);
            ...
            red_plus_Imagehs = (ImageView)rowViewhs[i].findViewById(R.id.red_plus_Image);
            int t = i+100;
            red_plus_Imagehs.setTag(t+"");
            red_plus_Imagehs.setLayoutParams(params3);
            red_minus_Imagehs = (ImageView)rowViewhs[i].findViewById(R.id.red_minus_Image);
            int t1 = i+1000;
            red_minus_Imagehs.setTag(t1+"");
            RelativeLayout red_minus_ImageRlhs = (RelativeLayout)rowViewhs[i].findViewById(R.id.red_minus_ImageRl);
            red_minus_ImageRlhs.setTag(t1+"");
            RelativeLayout red_plus_ImageRlhs = (RelativeLayout)rowViewhs[i].findViewById(R.id.red_plus_ImageRl);
          ...
          params4.addRule(RelativeLayout.CENTER_IN_PARENT);
           ...
           //units.setLayoutParams(params2);
            ...
            okler_pricehs.setText(okler_pricehs.getText().toString()+pdBean.getOklerPrice());
            ...
            red_plus_Imagehs.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					edd1.setId(id1);
					Utilities.writeToLogFIle("Cart: Hs: edd1 "+edd1.getText().toString());
					if(edd1.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Hs: edd2 "+edd1.getText().toString());
						edd1.setText("00");
						Utilities.writeToLogFIle("Cart: Hs: edd3 "+edd1.getText().toString());
					}
					...
					int unit = Integer.parseInt(edd1.getText().toString());
					if(unit>=99){
						Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
					}else{
					...
					Utilities.writeToLogFIle("Cart: Hs: prodlist setUnit");
					if(unit>9){
						edd1.setText(""+unit);
						}else{
							edd1.setText("0"+unit);
						}
					Utilities.writeToLogFIle("Cart: Hs: after settext"+unit);
					edd1.setLayoutParams(params4);
					Utilities.writeToLogFIle("Cart: Hs: params4");
					edd1.setBackgroundColor(getResources().getColor(R.color.White));
            ...
            red_plus_ImageRlhs.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Utilities.writeToLogFIle("Cart: Hs: edd1"+edd2.getText().toString());
					if(edd2.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Hs: edd2"+edd2.getText().toString());
						edd2.setText("00");
						Utilities.writeToLogFIle("Cart: Hs: edd2"+edd2.getText().toString());
					}
					...
					int unit = Integer.parseInt(edd2.getText().toString());
					if(unit>=99){
						Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
					}else{
					Utilities.writeToLogFIle("Cart: Hs: unit"+unit);
					...
					Utilities.writeToLogFIle("Cart: Hs: prodlistsetunit");
					if(unit>9){
						edd2.setText(""+unit);
						}else{
							edd2.setText("0"+unit);
						}
					Utilities.writeToLogFIle("Cart: Hs: after set text");
					edd2.setLayoutParams(params4);
					Utilities.writeToLogFIle("Cart: Hs: params");
					edd2.setBackgroundColor(getResources().getColor(R.color.White));
					Utilities.writeToLogFIle("Cart: Hs: white");
					int i1 = prodList.size();
					Utilities.writeToLogFIle("Cart: Hs: size"+i1);
					mainCart.setProdList(prodList);
	         ...
	         red_minus_Imagehs.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Utilities.writeToLogFIle("Cart: Hs: edd1"+edd3.getText().toString());
					if(edd3.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Hs: edd2"+edd3.getText().toString());
						edd3.setText("00");
						Utilities.writeToLogFIle("Cart: Hs: edd3"+edd3.getText().toString());
					}
					...
					int unit = Integer.parseInt(edd3.getText().toString());
					Utilities.writeToLogFIle("Cart: Hs: unit"+unit);
					if(unit<=1){
						unit=1;
						Utilities.writeToLogFIle("Cart: Hs: unit"+unit);
					...
					Utilities.writeToLogFIle("Cart: Hs: prodlistsetunits");
					int i1 = prodList.size();
					Utilities.writeToLogFIle("Cart: Hs: size"+i1);
					if(unit>9){
						edd3.setText(""+unit);
					...
					Utilities.writeToLogFIle("Cart: Hs: params");
					edd3.setBackgroundColor(getResources().getColor(R.color.White));
					Utilities.writeToLogFIle("Cart: Hs: white");
					mainCart.setProdList(prodList);
					Utilities.writeToLogFIle("Cart: Hs: setlist");
					Okler.getInstance().setMainCart(mainCart);
	         ...
	         red_minus_ImageRlhs.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Utilities.writeToLogFIle("Cart: Hs: edd1"+edd4.getText().toString());
					if(edd4.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Hs: edd2"+edd4.getText().toString());
						edd4.setText("00");
						Utilities.writeToLogFIle("Cart: Hs: edd3"+edd4.getText().toString());
					}
					...
					int unit = Integer.parseInt(edd4.getText().toString());
					Utilities.writeToLogFIle("Cart: Hs: unit"+unit);
					if(unit<=1){
						unit=1;
						Utilities.writeToLogFIle("Cart: Hs: unit"+unit);
		...
		//			myTextWatcher(edd4);
					...
					Utilities.writeToLogFIle("Cart: Hs: params");
					edd4.setBackgroundColor(getResources().getColor(R.color.White));
					Utilities.writeToLogFIle("Cart: Hs: white");
					mainCart.setProdList(prodList);
            	...
            	Utilities.writeToLogFIle("Exception Cart HS "+e.getStackTrace());
	         ...
	         /*units.addTextChangedListener(new TextWatcher() {
					...
					public void afterTextChanged(Editable s) {
						...
						String i = String.valueOf(units.getTag());
						int id = Integer.parseInt(i);
						int id1 = id-500;
						int id2 = units.getId();
						String uni = units.getText().toString();
						if(uni.equals("")||uni==null){
						prodList.get(id1).setUnits(00);
						}else{
							prodList.get(id1).setUnits(Integer.parseInt(uni));
						}
						setAmount();
					}
				});
	...
	private void setMeds() {
		final ArrayList<ProductDataBean> setPdList = new ArrayList<ProductDataBean>();
		ProductDataBean pdBean = new ProductDataBean();
		int size = prodList.size();
		...
		for (int i = 0; i < size2; i++) {
            ...
            RelativeLayout unitValueRl = (RelativeLayout)rowView[i].findViewById(R.id.unitValueRl);
            ...
            RelativeLayout red_minus_ImageRl = (RelativeLayout)rowView[i].findViewById(R.id.red_minus_ImageRl);
            red_minus_ImageRl.setTag(t1+"");
            RelativeLayout red_plus_ImageRl = (RelativeLayout)rowView[i].findViewById(R.id.red_plus_ImageRl);
           ...
           params4.addRule(RelativeLayout.CENTER_IN_PARENT);
            ...
            String desc="";
            if(pro_type==0){
            String one = pdBean.getGeneric_name();
            if(one == null || one.equals("null")|| one.equals(""))
            {
            	one = "";
            }
		    ...
		    deleteImage.setOnClickListener(new OnClickListener() {
	         ...
	         red_plus_Image.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Utilities.writeToLogFIle("Cart: Meds: edd1"+edd5.getText().toString());
					if(edd5.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Meds: edd2"+edd5.getText().toString());
						edd5.setText("00");
						Utilities.writeToLogFIle("Cart: Meds: edd3"+edd5.getText().toString());
					}
					...
					if(uni.length()>2)
					{
						...
						int unit = Integer.parseInt(edd5.getText().toString());
						if(unit>=99){
							Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
						}else{	
					...
					Utilities.writeToLogFIle("Cart: Meds: prodlistsetunits");
					if(unit>9){
						edd5.setText(""+unit);
						}else{
							edd5.setText("0"+unit);
						}
					Utilities.writeToLogFIle("Cart: Meds: aftersettext");
					edd5.setLayoutParams(params4);
					Utilities.writeToLogFIle("Cart: Meds: params");
					edd5.setBackgroundColor(getResources().getColor(R.color.White));
	         ...
	         red_plus_ImageRl.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Utilities.writeToLogFIle("Cart: Meds: edd1"+edd6.getText().toString());
						if(edd6.getText().toString().trim().equals("")){
							Utilities.writeToLogFIle("Cart: Meds: edd2"+edd6.getText().toString());
							edd6.setText("00");
							Utilities.writeToLogFIle("Cart: Meds: edd3"+edd6.getText().toString());
						}
						...
						if(uni.length()>2)
						{
							...
							int unit = Integer.parseInt(edd6.getText().toString());
							if(unit>=99){
								Toast.makeText(ack, "Maximum limit is 99", Toast.LENGTH_SHORT).show();
							}else{
					...
					Utilities.writeToLogFIle("Cart: Meds: params");
					edd6.setBackgroundColor(getResources().getColor(R.color.White));
					Utilities.writeToLogFIle("Cart: Meds: white");
						int i1 = prodList.size();
						Utilities.writeToLogFIle("Cart: Meds: size"+i1);
						mainCart.setProdList(prodList);
	         ...
	         red_minus_Image.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Utilities.writeToLogFIle("Cart: Meds: edd1"+edd7.getText().toString());
					if(edd7.getText().toString().trim().equals("")){
						Utilities.writeToLogFIle("Cart: Meds: edd2"+edd7.getText().toString());
						edd7.setText("00");
						Utilities.writeToLogFIle("Cart: Meds: edd3"+edd7.getText().toString());
					}
					...
					int unit = Integer.parseInt(edd7.getText().toString());
					Utilities.writeToLogFIle("Cart: Meds: unit"+unit);
					if(unit<=1){
						unit=1;
						Utilities.writeToLogFIle("Cart: Meds: unit"+unit);
					...
					Utilities.writeToLogFIle("Cart: Meds: params");
					edd7.setBackgroundColor(getResources().getColor(R.color.White));
					Utilities.writeToLogFIle("Cart: Meds: white");
					mainCart.setProdList(prodList);
					Utilities.writeToLogFIle("Cart: Meds: setlist");
					Okler.getInstance().setMainCart(mainCart);
	         ...
	         red_minus_ImageRl.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Utilities.writeToLogFIle("Cart: Meds: edd1"+edd8.getText().toString());
						if(edd8.getText().toString().trim().equals("")){
							Utilities.writeToLogFIle("Cart: Meds: edd2"+edd8.getText().toString());
							edd8.setText("00");
							Utilities.writeToLogFIle("Cart: Meds: edd3"+edd8.getText().toString());
						}
						...
						int unit = Integer.parseInt(edd8.getText().toString());
						Utilities.writeToLogFIle("Cart: Meds: unit"+unit);
						if(unit<=1){
							unit=1;
							Utilities.writeToLogFIle("Cart: Meds: unit"+unit);
						...
						Utilities.writeToLogFIle("Cart: Meds: params");
						edd8.setBackgroundColor(getResources().getColor(R.color.White));
						Utilities.writeToLogFIle("Cart: Meds: white");
						mainCart.setProdList(prodList);
						Utilities.writeToLogFIle("Cart: Meds: setlist");
						Okler.getInstance().setMainCart(mainCart);
					...
					Utilities.writeToLogFIle("Exception Cart Med "+e.getStackTrace());
				}
		}
	}
	...
	//	Toast.makeText(getApplicationContext(), err, Toast.LENGTH_LONG).show();
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				pdbean.setClipArtUrl(uobj.optString("productimage_clipArt_images"));
	...
	public void setAmount(){
		...
		for (int i = 0; i < length; i++) {
			pbean = prodList.get(i);
			Utilities.writeToLogFIle("Cart: SetAmount: pbean "+String.valueOf(pbean));
			...
			Utilities.writeToLogFIle("Cart: SetAmount: okler_pr"+okler_pr);
		...
		if(net_pay<=499){
			...
			Utilities.writeToLogFIle("Cart: SetAmount: net_pay ship "+net_pay);
		}
