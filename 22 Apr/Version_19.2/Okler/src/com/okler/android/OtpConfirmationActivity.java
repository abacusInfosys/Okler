			...
			public void onClick(View v) {
				...
				if(otpfompref.equals(otp_to_confirm))
				{
					if(in == 1)
					{
						...
						String forgot_pass = getResources().getString(R.string.serverUrl)+getResources().getString(R.string.forget_password)+"salutation="+"&customer_name="+customer_name+"email="+email;
						Log.d("Forgot pwd url", forgot_pass);
						WebJsonObjectRequest webObjReq=new WebJsonObjectRequest(Method.GET, forgot_pass, new JSONObject(),new Response.Listener<JSONObject>() 
							{
								@Override
								public void onResponse(JSONObject response) 
								{
									Log.d("Forgot password", "Web Serviceresponse received");
									try
									{
									...
									{
										Log.i("Forgot password", String.valueOf(e));
									}
								}
							...
							},new Response.ErrorListener() 
							{
								...
								public void onErrorResponse(VolleyError error) {
									// TODO Auto-generated method stub
									Log.d("Forgot password", "Error"+error);
									//712016****
									Toast.makeText(getApplicationContext(),"No Network Connection",Toast.LENGTH_LONG).show();
									Log.d("Forgot password", "Web Service called");
							}
						...
						/*	if(flag == 0)
							{*/
								DefaultRetryPolicy retry = new DefaultRetryPolicy(3000,0, 2);
							...
							PasswordConfirmationDialog newpass = new PasswordConfirmationDialog(OtpConfirmationActivity.this);
							newpass.show();	
						
					}
					else
					{
						userBean= Utilities.getCurrentUserFromSharedPref(OtpConfirmationActivity.this); //Okler.getInstance().getuDataBean();
						Gson gson=new Gson();
						nameValuePairs.add(new BasicNameValuePair("user_id", String.valueOf(userBean.getId())));
						nameValuePairs.add(new BasicNameValuePair("approved_status", String.valueOf(1)));						
						new ResetpassAsyncTask().execute("");						
						/*Intent intent = new Intent(OtpConfirmationActivity.this, ServiceCategoryActivity.class);
