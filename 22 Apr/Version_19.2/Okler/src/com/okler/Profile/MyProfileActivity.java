	...
	public void onResponse(Object response) 
	{
		...
		try
		{
			...
			for(int i = 0 ; i < doctorsArr.length();i++)
			{
				...
				adDatabean.setDefault_billing(Integer.parseInt(docObj.optString("default_billing")));
				adDatabean.setDefault_shipping(Integer.parseInt(docObj.optString("default_shiping"))); 
