...
public class EditProfile extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UsersDataBean userbean = Utilities.getCurrentUserFromSharedPref(EditProfile.this);
		uid = userbean.getId();
		...
		imagepencil.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				CameraGalleryDialog cameragallary = new CameraGalleryDialog(EditProfile.this);
				cameragallary.show();
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				nameValuePairs.add(new BasicNameValuePair("image", base64string));
		...
		changePass.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(getApplicationContext(), ProfileChangePassword.class);
				startActivity(in);
			}
		});
		...
		txtdob.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    txtdob.setText("");
					fromDatePickerDialog = new DatePickerDialog(EditProfile.this, new OnDateSetListener() 
					{
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		CameraGalleryImageInfo imgInfo = Utilities.getImageInfo(arg0, arg1, this, arg2);
		...
		//	if (respstatus == "1")
			{
				...
				userBean=Utilities.getCurrentUserFromSharedPref(EditProfile.this);
				...
				Log.i("Fname", "Fname is"+fname + "User Bean fname:"+userBean.getFname());
				Log.i("lname", "lname is"+lname + "User Bean lname:"+userBean.getLname());
				Utilities.writeUserStatusEnumToSharedPref(EditProfile.this, UserStatusEnum.LOGGED_IN);
				Utilities.writeCurrentUserToSharedPref(EditProfile.this, userBean);
