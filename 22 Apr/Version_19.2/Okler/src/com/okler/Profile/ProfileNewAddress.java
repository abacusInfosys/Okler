...
public class ProfileNewAddress extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				fromDatePickerDialog = new DatePickerDialog(act, new OnDateSetListener() 
				{
				     ...
				     public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) 
				    {
				        ...
				        String ddd = dateFormatter.format(newDate.getTime());
		...
		if(content == 2)
		{
			...
			try {
				...
				if(r_id==null||r_id.equals("null")||r_id.equals("")||r_id=="0"||r_id.equals("0")){
					r_id="1";
				}
				...
				if(g_id==null||g_id.equals("null")||g_id.equals("")||g_id.equals("m")){
					g_id="0";
				}
	...
	if(Okler.getInstance().getBookingType()==9||Okler.getInstance().getBookingType()==20){
			add_address = "https://www.okler.com/api/users/AdduserPatientAddress?user_id=" + user_id  
					+"&firstname=" + name1 +"&surname=" + surname1 + "&dob=" + dob + "&relationid=" + rel_id + "&gender=" + gid+ "" 
		 ...
		 add_address = getResources().getString(R.string.add_patient_address) + "customer_id="+ user_id + "&company="+ "" 
				+"&customer_name=" + name +"&surname=" + surname + "&dob=" + dob + "&relationid=" + rel_id + "&gender=" + gid+ "" 
				+"&email=" + "" + "&mobileNo=" + mobile + "&addr1=" + add1 + "&addr2=" + add2 + "&landmark=" + landmark1 + "&zip="+pincode
	...
	//String pat_id="";
		...
		add_address = getResources().getString(R.string.add_patient_address) +"addr_id="+addrerss_id+"&customer_id="+ user_id+"" + "&company="+ "" 
				+"&customer_name=" + name1 +"&surname=" + surname1 + "&dob=" + dob + "&relationid=" + rel_id + "&gender=" + gid+ "" 
