	 ...
	 dlg.setView(view)
			...
			.setPositiveButton("Logout", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					...
					dismiss();
					//Need to rewrite otp status because if user logs out and tried to Sign Up again, otp must be verified again
					Utilities.writeStringToSharedPref(getActivity().getApplicationContext(),"otpStatus","NotVerfied");	
				}
			})
