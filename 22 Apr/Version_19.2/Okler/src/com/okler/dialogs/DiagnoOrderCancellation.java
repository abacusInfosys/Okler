...
public class DiagnoOrderCancellation extends Dialog implements android.view.View.OnClickListener {
	public Activity c;
	  ...
	  public DiagnoOrderCancellation(Activity a,String cid,String oid,String date) {
			super(a);
			...
			//				if(bookingOrderType == 2 || bookingOrderType == 4)
				...
				/*			else
							...
							{	
								...
								String diagno_order_cancel = c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.diagno_order_cancel_url)+"salutation="+salutation+"&cust_id="+uid+"&customer_name="+name+"&email="+email+"&order_number="+order_id+"&reason="+reason+"&date="+date;
								
								WebJsonObjectRequest webObjReq=new WebJsonObjectRequest(Method.GET, diagno_order_cancel, new JSONObject(),new Response.Listener<JSONObject>() 
										{
