...
public class DialogCancellation extends Dialog implements android.view.View.OnClickListener {
	...
	public Activity c;
	  ...
	  public void onClick(View v) {
		...
		//  ArrayList<OrdersDataBean> arr_odbean = Okler.getInstance().getUsersOrders();
		  ...
		  order_date = obean.getDate(); 
	    	...
	    	String cancel = "https://www.okler.com/api/order/delete?order_id="+order_id+"&cust_id="+id+"&notes=";
	   ...
	   // 	Toast.makeText(c, "text_no_need", Toast.LENGTH_LONG).show();
	    	...
	    	String cancel_order;
	    	cancel_order = c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.cancel_order)+"order_id="+order_id+"&cust_id="+id+"&notes="+reason;	    	Log.i("delete url",cancel_order);
	    	webjson=new WebJsonObjectRequest(Method.GET, cancel_order, new JSONObject(),new Listener<JSONObject>() 
					{
						...
						public void onResponse(JSONObject response) 
						{
							...
							if(message.equals("Your order has been cancelled"))
							{
								customer_name = URLEncoder.encode(customer_name,"UTF-8");
								
								String order_cancel =c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.order_cancel)+"salutation="+"&cust_id="+id+"&customer_name="+customer_name+"&email="+email+"&order_number="+order_id+"&reason="+reason+"&order_date="+order_date;
								WebJsonObjectRequest webObjReq=new WebJsonObjectRequest(Method.GET, order_cancel, new JSONObject(),new Response.Listener<JSONObject>() 
										{
	    ...
	    case R.id.text_too_late:
	    	...
	    	cancel_order = c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.cancel_order)+"order_id="+order_id+"&cust_id="+id+"&notes="+reason;	    	webjson=new WebJsonObjectRequest(Method.GET, cancel_order, new JSONObject(),new Listener<JSONObject>() 
					{
						@Override
						public void onResponse(JSONObject response) 
						{
...
String order_cancel =c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.order_cancel)+"salutation="+"&cust_id="+id+"&customer_name="+customer_name+"&email="+email+"&order_number="+order_id+"&reason="+reason+"&order_date="+order_date;
	    ...
	    case R.id.text_by_mistake:
	    	...
	    	cancel_order = c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.cancel_order)+"order_id="+order_id+"&cust_id="+id+"&notes="+reason;
	    	webjson=new WebJsonObjectRequest(Method.GET, cancel_order, new JSONObject(),new Listener<JSONObject>() 
					{
						@Override
						public void onResponse(JSONObject response) 
