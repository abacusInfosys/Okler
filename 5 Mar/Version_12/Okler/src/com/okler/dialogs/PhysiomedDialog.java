			...
			//				if(bookingOrderType == 2 || bookingOrderType == 4)
				...
				/*			else
							...
							if(message.equals(strToCompare))
							{
								...
								String service_cancel = c.getResources().getString(R.string.serverUrl)+c.getResources().getString(R.string.service_cancel)+"salutation="+"&cust_id="+uid+"&customer_name="+customer_name+"&email="+email+"&order_number="+"&reason="+reason+"&service=";
