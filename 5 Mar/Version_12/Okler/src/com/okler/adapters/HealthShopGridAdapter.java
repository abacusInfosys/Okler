...
public class HealthShopGridAdapter extends BaseAdapter {
    ...
    Activity c;
      ...
      /*public HealthShopGridAdapter(Context cntx, String[] prgmNameList, int[] prgmImages)
      {
    	  result=prgmNameList;
          context=cntx;
          imageId=prgmImages;
...
*/
    public HealthShopGridAdapter(Activity con, ArrayList<ProductDataBean> prodDataBean,Button cart) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        /* rowView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	Intent intent = new Intent(context, HealthShopListView.class);
	 		    	...
	 		    	WebJsonObjectRequest webjson=new WebJsonObjectRequest(Method.GET, add_fav, new JSONObject(),new Listener<JSONObject>() 
	 						{
	 							...
	 							public void onResponse(JSONObject response) 
	 							{
	 								...
	 								{
	 									Intent intent = new Intent(c, FavouritesActivity.class);
	 							...
	 							new Response.ErrorListener() 
	 							{
	 								...
	 								public void onErrorResponse(VolleyError error) 
	 								{
	 									...
	 									Toast.makeText(c, "Failed to add product to favorites", Toast.LENGTH_LONG).show();
