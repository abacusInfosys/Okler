...
public class MedPrescListAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.docName.setText(medPrescHistory.get(position).getDocName()+" "+medPrescHistory.get(position).getDocSirname());
        ...
        /*convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ConfirmPrescDialog cdlg = new ConfirmPrescDialog(context, presId);
