...
import com.okler.dialogs.VerifyPhoneNumDialog.ResetpassAsyncTask;
import com.okler.dialogs.VerifyPhoneNumDialog.SignUpAsyncTask;
...
public class ResendOtpDialog extends DialogFragment {
	...
	public ResendOtpDialog(Activity context) {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = getActivity().getLayoutInflater().inflate(
				R.layout.dialog_resend_otp, null);
		...
		UsersDataBean userBean1 = Utilities.getCurrentUserFromSharedPref(actCntx);
		
		phoneNumberReceived = userBean1.getPhone();
		/*if (isFromNewSignIn) {
			...
			protected void onPostExecute(Object result) {
				...
				try {
					...
					if(messageReceived.equals("User registration successful."))
					{
						...
						//Utilities.writeApprovedStatusToFile("0");
