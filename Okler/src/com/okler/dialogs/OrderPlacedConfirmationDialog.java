...
public class OrderPlacedConfirmationDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = getActivity().getLayoutInflater().inflate(
				R.layout.dialog_order_confirm, null);
		 ...
		 * Intent startHome = new Intent(receivedContext,
		 * ServicesCategories.class); startActivity(startHome); dismiss(); }
		 */
		 ...
		 * Auto-generated method stub Intent startHome = new
		 * Intent(receivedContext, ServiceCategoryActivity.class);
		 * startHome.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		 * startActivity(startHome); } });
		 */
		return alert;
