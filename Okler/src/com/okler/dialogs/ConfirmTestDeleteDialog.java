...
public class ConfirmTestDeleteDialog extends DialogFragment {
	...
	public ConfirmTestDeleteDialog(Context context, int gotid,
			LinearLayout linLayout, String pick) {
		this.con = context;
		this.id = gotid;
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = getActivity().getLayoutInflater().inflate(
				R.layout.dialog_confirm_test_delete, null);
		dlg.setView(view).setTitle("Confirm Delete")
